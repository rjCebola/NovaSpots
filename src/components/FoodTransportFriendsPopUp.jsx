...
const LayersPopUp = ({setState}) => {
  ...
  return (
    <SliderAnimation showing={!closing} className="fixed bottom-0 w-full z-[999] bg-white p-4 rounded-t-3xl flex h-1/6 justify-around items-center shadow-2xl shadow-black">
