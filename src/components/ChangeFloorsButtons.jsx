...
function ChangeFloorsButton({ building, setBuilding }) {
    ...
    return <>
        ...
        <div className="fixed bottom-0 right-0 z-[999] mb-4 mr-4 bg-white p-2 rounded-2xl flex flex-col justify-between items-center shadow-2xl shadow-black group">
            <FontAwesomeIcon
                onClick={() => { 
